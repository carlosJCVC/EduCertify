...
class ParticipantController extends Controller
{
    ...
    { 
        return DataTables::of(Participant::query())
            ...
            ->addColumn('birthdate', fn ($record) => is_null($record->birthdate) ? '' : $record->birthdate->format('Y M,d'))
            ->addColumn('created_at', fn ($record) => $record->created_at->format(config('app.format_time')))
